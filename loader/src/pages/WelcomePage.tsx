...
export const WelcomePage: Component<{
  ...
  return (
    <div class="flex flex-col justify-center items-center my-auto">
      <div class="mb-8">
        <h2 class="text-4xl font-semibold text-center">{i18n.t('welcome.welcome')}</h2>
      </div>
      <div class="flex flex-col gap-8 max-w-60">
        <div class="gap-2">
          <p class="text-sm my-2 pl-2">{i18n.t('welcome.choose_lang')}</p>
          <ComboBox
        ...
        <label class="flex space-x-2">
          ...
          <div class="grid gap-1.5 leading-none">
            <h2 class="text-sm font-medium leading-none">{i18n.t('welcome.accept_tos')}</h2>
            <p class="text-sm text-muted-foreground">{i18n.t('welcome.tos_content')}</p>
          </div>
        </label>
        <div class="mt-4">
